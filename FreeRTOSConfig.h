...
// INCLUDE THE VTASK DELAY and VTaskDelayUntil API
...
// enable v task delete
#define INCLUDE_vTaskDelete 1

// Include Set bits from an ISR
#define INCLUDE_xEventGroupSetBitFromISR 1


//use Timers
#define configUSE_TIMERS 1
// include the timerpendFunction call to enable context switching from an isr
#define INCLUDE_xTimerPendFunctionCall  1

// define the timer task priority
