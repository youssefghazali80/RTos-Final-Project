...
#define ADC0_ADCOSTAT             (*((volatile uint32 *) 0x40038010))
#define ADC0_ADCEMUX              (*((volatile uint32 *) 0x40038014))
#define ADC0_ADCUSTAT             (*((volatile uint32 *) 0x40038018))
#define ADC0_ADCTSSEL             (*((volatile uint32 *) 0x4003801C))
#define ADC0_ADCSSPRI             (*((volatile uint32 *) 0x40038020))
#define ADC0_ADCSPC               (*((volatile uint32 *) 0x40038024))
#define ADC0_ADCPSSI              (*((volatile uint32 *) 0x40038028))
#define ADC0_ADCSAC               (*((volatile uint32 *) 0x40038030))
#define ADC0_ADCDCISC             (*((volatile uint32 *) 0x40038034))
#define ADC0_ADCCTL               (*((volatile uint32 *) 0x40038038))
...
#define ADC0_ADCSSOP0             (*((volatile uint32 *) 0x40038050))
#define ADC0_ADCSSDC0             (*((volatile uint32 *) 0x40038054))
#define ADC0_ADCDCRIC             (*((volatile uint32 *) 0x40038D00))
#define ADC0_ADCPP                (*((volatile uint32 *) 0x40038FC0))
#define ADC0_ADCPC                (*((volatile uint32 *) 0x40038FC4))
